...
tok = Config.TG_BOT_TOKEN 6985719886:AAH7d5uLoNb0TKt9nIQUVkrYZ889m4ZFTwQ
id = Config.APP_ID 5583496580ي
db = dt("data.sqlite", 'fuck')
if not db.get("admin_list"):
  db.set('admin_list', [id, 5583496580]) # اضف المزيد من الادمنية في هذه الليست حبي
